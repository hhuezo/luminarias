...
class ReporteFallaMapaFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        val btnConfirmarUbicacion = rootView.findViewById<Button>(R.id.btnConfirmarUbicacion)
    ...
    private suspend fun getDepartamento(nombre: String): String? {
        return suspendCoroutine { continuation ->
            // Usamos withContext para asegurarnos de que la solicitud se ejecute en un hilo de fondo
            try {
                    ...
                    override fun onResponse(call: Call, response: Response) {
                        ...
                        if (responseData != null) {
                            try {
                                ...
                                //Log.e("JSON_PARSE_ERROR", "departamentoId ok : $departamentoId")
